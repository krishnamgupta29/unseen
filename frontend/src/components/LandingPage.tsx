    ...
    >
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 pt-20 pb-32">
        ...
        >
          ...
          <Link href="/download" className="w-full sm:w-auto px-8 py-3.5 rounded-full glass glass-glow text-white font-semibold text-base md:text-lg transition-all flex items-center justify-center gap-2 text-center transform md:hover:scale-105 active:scale-95">
