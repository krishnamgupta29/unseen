...
exports.detectSpamPost = detectSpamPost;
exports.moderateWithAI = moderateWithAI;
 ...
 */
const recentPostHashes = new Map();
function detectSpamPost(userId, content) {
    const now = Date.now();
 ...
 */
async function moderateWithAI(_content) {
